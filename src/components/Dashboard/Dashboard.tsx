        ...
        return selectedLeague ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="text-center space-y-3">
              ...
              <h3 className="text-lg font-medium text-foreground">Nenhuma Liga Selecionada</h3>
              <p className="text-muted-foreground max-w-sm">Selecione uma liga para ver os membros e suas informações</p>
            </div>
          </div>
        );
      case 'matches':
        return selectedLeague ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="text-center space-y-3">
              ...
              <h3 className="text-lg font-medium text-foreground">Nenhuma Liga Selecionada</h3>
              <p className="text-muted-foreground max-w-sm">Selecione uma liga para ver os jogos e fazer suas apostas</p>
            </div>
          </div>
        );
      case 'ranking':
        return selectedLeague ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="text-center space-y-3">
              ...
              <h3 className="text-lg font-medium text-foreground">Nenhuma Liga Selecionada</h3>
              <p className="text-muted-foreground max-w-sm">Selecione uma liga para ver o ranking dos participantes</p>
            </div>
          </div>
        );
      case 'bets':
        return selectedLeague ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="text-center space-y-3">
              ...
              <h3 className="text-lg font-medium text-foreground">Nenhuma Liga Selecionada</h3>
              <p className="text-muted-foreground max-w-sm">Selecione uma liga para ver as apostas dos membros</p>
            </div>
          </div>
        );
      case 'leagueBets':
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-primary-foreground bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring transition-all duration-200 shadow-sm hover:shadow-md"
              >
